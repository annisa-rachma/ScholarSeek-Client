...
export default function ParticipantsSideBar({
    ...
    return (
        <>
            ...
            >
                <header className="bg-primary text-lg py-4 px-6 flex items-center gap-7 justify-between">
                    {width < BREAKPOINT && (
                        <CloseButton
                            className="text-xl"
                    ...
                    <p>Participants</p>
                    <span className="py-1 px-4 rounded-lg bg-black/30">
                        {participantsCount}
                    </span>
                </header>

                <div className="overflow-y-scroll scrollbar h-full bg-white text-slate-400">
